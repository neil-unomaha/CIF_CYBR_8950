...
|Roadblocks to setting up test environment | 5 | 2 | It is critical to setup a test environment in order to aid in the development and testing of the API.  | Step through the installation process within the CIF4 documentation. If trouble arises, consult Brian for assistance.|
...
|University policies prevent deployment of the developed feature| 7 | 1 | Large enterprise often have complex, multi-step approval processes.  It is possible that we might develop the product, but due to a variety of possible concerns, such as security or lack of justification, the feature may be halted from going live. | Brian is our main point of contact and a key stakeholder for cyber security within UNO.  It is important we maintain communication with him throughout our progress, and that he finds the project's progress satisfactory. |
